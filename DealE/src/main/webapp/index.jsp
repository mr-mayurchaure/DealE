...
<body>
    ...
    <section class="menu-section">
        <div class="top-bar">
            ...
            <div class="full-logo">
            <ul class="menu">
                <img src="drawable/icon-circle.png" >
                <span>DealE</span>
            </ul>
        </div>
            ...
            <div class="top-bar--right-menu">
                ...
                <div class="cart-container">
                    <a href="login.jsp"><i class="fa-solid fa-cart-shopping"></i></a>
    ...
    <div class="signup-container">
        <div class="signup-box">
            ...
            <div class="signup-desc">
                <span>Sign up to get the latest on sales, new releases and more …
                </span>

                <div class="mail-box">
                    <input required="" type="email" name="text" placeholder="Email" name="text" autocomplete="off" class="input">
                ...
                <div class="box">
                  ...
                  <a href="signup.jsp"><button class="signup-btn" style="vertical-align:middle"><span>SIGN UP</span></button></a>
